<x-form-layout>
    <div class="flex flex-col justify-center items-center text-center w-full">
        ...
        <span class="bg-[#86A173] py-4 px-52 rounded-full mt-6 font-inria text-[#F6F5EE] text-md font-normal">5 Mac 2025
            sehingga 27 Mac 2025</span>
        <div class="flex flex-col rounded-tl-[160px] rounded-tr-[160px] justify-center items-center bg-[#F6F5EE] mt-6 w-full"
            id="price-list">
            <div class="flex flex-row justify-evenly items-start mt-8 text-[#F6F5EE] font-semibold">
                @foreach ($prices as $pr)
                    <div class="flex flex-col rounded-3xl bg-[#078287] {{ $pr->id == 2 ? 'p-6' : 'p-5' }} mx-6">
                        <div class="flex flex-row justify-center">
                            <span
                                class="text-sm content-start pt-4 {{ $pr->id == 2 ? 'text-[#133944]' : '' }}">RM</span>
                            <span
                                class="text-[55px] {{ $pr->id == 2 ? 'line-through text-[#133944]' : '' }}">{{ $pr->normal_price }}</span>
                        </div>
                        @if ($pr->id == 2)
                            <div class="flex flex-row justify-center">
                                <span class="text-sm content-start pt-4">RM</span>
                                <span class="text-[55px]">58</span>
                            </div>
                        @endif
                        <span class="text-md uppercase tracking-widest font-normal pb-4">{{ $pr->name }}</span>
                        @if ($pr->id == 2)
            ...
            <div class="flex flex-col border-2 border-[#86A173] w-3/4 rounded-[35px] mt-6" id="tempah-sekarang">
                ...
                <form action="">
                    ...
                    <div class="flex flex-row justify-between mx-auto w-full pb-4 px-48">
                    ...
                    @foreach ($prices as $price)
                        <div class="flex flex-row justify-between items-center mx-auto w-full pb-4 px-48">
                            <div class="flex flex-col w-1/5 mr-4">
                                <span
                    ...
                    <div class="flex flex-row justify-end items-center mx-auto w-full pb-4 px-48">
                    ...
                    <div class="flex flex-row justify-end items-center mx-auto w-full pb-4 px-48">
                        <input type="submit" value="Bayar Sekarang"
                            class="font-medium text-md text-center tracking-wider bg-gray-50 rounded-full border-0 px-4 py-2 w-1/2">
                    </div>
                </form>
            </div>
                    ...
                    <div class="flex flex-row pt-3">
                        <div class="flex flex-col mr-4">
                            <div class="flex flex-row justify-between items-center">
                                <span class="font-normal text-sm tracking-wider pt-2">Myra</span>
                                <a href=""><img src="{{ asset('img/ws.png') }}" class="w-[25px]"
                                        alt=""></a>
                            </div>
                            <span class="font-normal text-sm tracking-wider pt-2">+6012 345 6789</span>
                        </div>
                        <div class="flex flex-col mr-4">
                            <div class="flex flex-row justify-between items-center">
                                <span class="font-normal text-sm tracking-wider pt-2">Myra</span>
