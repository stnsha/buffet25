<x-form-layout>
    <div class="font-inter flex flex-col w-full mx-auto justify-center items-center h-screen mb-24">
        <img src="{{ asset('img/failed.svg') }}" alt="failed" class="w-3/4">
        <div class="flex flex-col w-full">
            <div class="flex flex-col justify-center items-center">
                <span class="font-medium text-md text-center py-4">Maaf, tempahan anda tidak berjaya. Sila cuba sekali
                    lagi.</span>

                <div class="flex flex-col md:flex-row justify-evenly w-full md:w-1/2 mx-auto items-center bg-red-200 text-slate-800 rounded-3xl py-4 my-6 px-6"
                    id="hubungi-kami">
